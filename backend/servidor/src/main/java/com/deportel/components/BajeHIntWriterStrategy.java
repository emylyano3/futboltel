...
public class BajeHIntWriterStrategy extends BjaeDataWriter
{
	...
	protected void validateData (Propiedad property)
	{
		...
		{
			this.data = Utils.intToByteArray(Integer.parseInt(property.getDRegularData(), Constants.HEXA_DECIMAL));
		}
	}
}
