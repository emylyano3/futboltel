...
public class BajeHLongWriterStrategy extends BjaeDataWriter
{
	...
	protected void validateData (Propiedad property)
	{
		...
		{
			this.data = Utils.longToByteArray(Long.parseLong(property.getDRegularData(), Constants.HEXA_DECIMAL));
		}
	}
}
