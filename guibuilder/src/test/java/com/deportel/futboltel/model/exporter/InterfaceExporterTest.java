package com.deportel.futboltel.model.exporter;
...
public class InterfaceExporterTest
{
	private Logger			log		= Logger.getLogger(InterfaceExporterTest.class);

	private static File		xmlFile;

	private static String	projectPath = "C:/";

	private static String	xmlPath	= projectPath + "src/main/resources/settings/" + "xmlAux.xml";
	...
	@Ignore
	@Test
	public void generateInterface () throws UserShowableException
	{
		this.log.debug("Inicia el test de loadGui");
		InterfaceExporter.generateInterface
		(
				projectPath,
				xmlPath,
				"com.deportel.futboltel.view"
		);
	...
	{
		return new JUnit4TestAdapter(InterfaceExporterTest.class);
	}

	public static void main(String[] args)
	{
		JUnitCore.runClasses(InterfaceExporterTest.class);
	}
