...
import com.deportel.futboltel.torneo.dao.HorarioDao;
import com.deportel.futboltel.torneo.modelo.Horario;

public class HorarioDaoHibernate extends TorneoGenericDaoHibernate<Horario, Integer> implements HorarioDao
{
